...
const ListPage = ({ heading }) => {
  ...
  const uri = `https://anime-x.vercel.app/api/list/${vari}/${page}`;
  useEffect(() => {
    setLoading(true);
    ...
    <>
      ...
      <Container>
        <div
          style={{
            backgroundImage:
              "linear-gradient(135deg, rgb(42,115,113) 0%, rgb(42,115,113) 1%,rgb(2,168,148) 1%, rgb(2,168,148) 53%,rgb(0,214,193) 53%, rgb(0,214,193) 57%,rgb(85,90,102) 57%, rgb(85,90,102) 69%,rgb(65,73,82) 69%, rgb(65,73,82) 75%,rgb(35,39,43) 75%, rgb(35,39,43) 100%)",
            borderRadius: "20px",
          }}
        >
          <Alpha>
