  ...
  return (
    <Link href={href}>
      <span
        ...
        className={`${style} ${theme.button.background} border ${theme.button.text} ${theme.button.border} hover:${theme.button.hover.background} hover:${theme.button.hover.text} shadow-2xl transition-all duration-500`}
      >
        {children}
      </span>
    </Link>
